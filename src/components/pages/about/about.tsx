...
export function About() {
    return(
        <main className="relative flex flex-col justify-center gap-10 w-full h-screen px-[15%] text-[#ddd]">
            {/*<div*/}
            {/*    className="absolute inset-0 bg-[url('/paper-texture.jpg')] bg-repeat opacity-10 mix-blend-multiply pointer-events-none z-0"*/}
            {/*/>*/}

            <h1 className="relative text-3xl font-light tracking-widest z-10">Our Mission</h1>

            <p className="relative text-xl font-light leading-7 w-[60%] tracking-widest z-10">
