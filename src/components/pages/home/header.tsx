...
export function Header() {
    ...
    return (
        <header className="flex text-white w-full max-sm:px-[5%] px-[15%] py-5 items-center justify-between h-[10%] relative z-50">
            <Link href="/" className="font-black text-3xl tracking-tighter">OSM</Link>

            {/* Desktop nav */}
            <nav className="hidden md:flex gap-5 tracking-wide font-light items-center">
